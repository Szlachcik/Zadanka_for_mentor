...
def create_contacts(card_type, quantity):
    if card_type == "BaseContact":
        ...
        for _ in range(quantity):
            print(BusinessContact("position", "company_name", "business_phone", "first_name", "last_name",
                                  "private_phone", "email"))
        return ""
...
Business_p = BusinessContact("position", "company_name", "business_phone", "first_name", "last_name", "private_phone",
                             "email")
